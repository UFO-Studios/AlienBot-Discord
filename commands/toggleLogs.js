    ...
    if (data == false) {
      ...
      channel
        .createWebhook({
          name: "AlienBot Logs",
          avatar:
            "https://raw.githubusercontent.com/UFO-Studios/TheAlienDoctor.com/main/img/alienbot/face-1080x1080.png",
        })
        .then((webhook) => console.log(`Created webhook ${webhook}`))
        .catch(console.error);
      interaction.reply(
        "Logging has been turned on for the first time! Ive set everything up for you. If this is not the channel you want to use for logging, go to channel settings > webhooks and delete it. Then run this command again in the channel you want to use for logging."
      );
    } else {
